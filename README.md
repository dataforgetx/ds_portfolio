# About 
This repository contains several data science projects that I completed over the years. Each project has a README file, script files, data files (if allowed), and report (if available). 

## projects
- EIS: completed in March/2021 at Los Angeles County Probation Department
